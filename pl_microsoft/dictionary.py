...
# Open Weather Map
    Phrase(u"Open Weather Map",
           sounds_like=u"ołpen łeder map",
           save_as="openweathermap"),
    Phrase(u"bardzo silny deszcz"),
    Phrase(u"bardzo silny wiatr"),
    Phrase(u"bezchmurnie"),
    Phrase(u"burza"),
    Phrase(u"burza tropikalna"),
    Phrase(u"burza z intensywnymi opadami deszczu"),
    Phrase(u"burza z intensywną mżawką"),
    Phrase(u"burza z lekkimi opadami deszczu"),
    Phrase(u"burza z lekką mżawką"),
    Phrase(u"burza z mżawka"),
    Phrase(u"burza z opadami deszczu"),
    Phrase(u"chłodno"),
    Phrase(u"delikatna bryza"),
    Phrase(u"deszcz"),
    Phrase(u"deszcz przechodzący w mżawkę"),
    Phrase(u"deszcz ze śniegem"),
    Phrase(u"gorąco"),
    Phrase(u"grad"),
    Phrase(u"gwałtowny sztorm"),
    Phrase(u"huragan"),
    Phrase(u"intensywna mżawka"),
    Phrase(u"intensywny deszcz"),
    Phrase(u"intensywny deszcz przechodzący w mżawkę"),
    Phrase(u"lekka bryza"),
    Phrase(u"lekka burza"),
    Phrase(u"lekka mżawka"),
    Phrase(u"lekki deszcz"),
    Phrase(u"lekkie opady drobnego deszczu"),
    Phrase(u"lekkie opady śniegu"),
    Phrase(u"lekkie zachmurzenie"),
    Phrase(u"marznący deszcz", sounds_like="mar-znący deszcz"),
    Phrase(u"mgła"),
    Phrase(u"mocne opady śniegu"),
    Phrase(u"mżawka"),
    Phrase(u"pochmurno"),
    Phrase(u"pochmurno z przejaśnieniami"),
    Phrase(u"przelotne ulewy"),
    Phrase(u"silna bryza"),
    Phrase(u"silna burza"),
    Phrase(u"silna mżawka"),
    Phrase(u"silna wichura"),
    Phrase(u"smog"),
    Phrase(u"spokojnie"),
    Phrase(u"sztorm"),
    Phrase(u"tornado"),
    Phrase(u"ulewa"),
    Phrase(u"umiarkowana bryza"),
    Phrase(u"umiarkowany deszcz"),
    Phrase(u"wichura"),
    Phrase(u"wietrznie"),
    Phrase(u"zachmurzenie umiarkowane"),
    Phrase(u"zamglenia"),
    Phrase(u"zamieć piaskowa"),
    Phrase(u"śnieg"),
    Phrase(u"śnieżyca"),
    Phrase(u"świeża bryza"),
)
