...
def cw(text, wpm=25, farnsworth=None, weight=None, pitch=600,
    ...
    # see http://www.ac6v.com/morseaids.htm, or believe me that typical word
    ...
    #
    # This function returns ``pygame.sndarray`` compatible data
    # (``Numeric.aray``).
    ...
    # Farnsworth (after Farnsworth method, see Google) lest us to make
    # interLetter and interWord pauses longer, but we need to recalculate
    # ``unit``'s length:
